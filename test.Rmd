...
Since its launch, in August 2021, the Social Science Reproduction Platform (SSRP) has help `r reproductions` students and researchers around the world record the result of their reproductions in a standardized way. As part of their exercise, these reproducers have assessed a total of `r papers` papers, and a total of `r claims` claims. 
...
testdata <- data.frame(admin = world$admin,
                       nreproductions = c(rep(0,29),
                                          0, # 2 Chile reproductions
                                          rep(0,138),
                                          14, # 5 US reproductions
                                          rep(0,8)))
