...
- Select repro_id, clean_doi, title identifier, original title, summary of each claim and names of display items for each claim
...
df_spec <- df %>% 
    ...
    pivot_longer(
        #reshape to long
        cols = !c(repro_id, clean_doi, similar_title, S0_1Q1P2),
